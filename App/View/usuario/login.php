    ...
    <div class="container">
        <div class="blog-banner">
            <div class="mt-5 mb-5 text-left">
                <h1 class="">Login / Criar nova conta</h1>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-6">
                <div class="login_box_img">
                    <div class="hover">
                        ...
                        <a class="button button-account" style="color: var(--c-nexgen);" href="<?= baseUrl() ?>Home/criarConta">Crie sua conta aqui</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="login_form_inner">
                    ...
                    <form method="POST" class="row login_form" action="<?= baseUrl() ?>Login/signIn" id="contactForm">
                        ...
                        <div class="col-12 form-group mt-3">
                            <button type="submit" value="submit" class="btn btn-nexgen ">Entrar</button>
